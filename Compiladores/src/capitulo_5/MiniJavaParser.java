...
public class MiniJavaParser implements MiniJavaParserConstants {
  ...
  static final public MainClass MainClass(Identifier i1, Identifier i2, Statement s) throws ParseException {
        Token t1, t2;
  ...
  static final public ClassDecl ClassDecl(Identifier i1, VarDeclList vl, MethodDeclList ml) throws ParseException {
  Identifier i2;
  Token t, t1;
  VarDecl v;
  MethodDecl m;
    if (jj_2_1(3)) {
      ...
      jj_consume_token(RKEY);
          {if (true) return new ClassDeclSimple(i1, vl, ml);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case CLASS:
        jj_consume_token(CLASS);
  ...
  static final public MethodDecl MethodDecl(Type t, Identifier i, FormalList fl, VarDeclList vl, StatementList sl, Exp e) throws ParseException {
  Token tk;
  VarDecl v;
  Statement s;
    jj_consume_token(PUBLIC);
  ...
  static final public FormalList FormalRest(FormalList fl) throws ParseException {
  Type t;
  Token tk;
  Identifier i;
  Formal f;
  ...
  static final public VarDecl VarDecl(Type t, Identifier i) throws ParseException {
  Token t1;
    t = Type();
    t1 = jj_consume_token(ID);
  ...
  System.out.println("T --> FALSE(" +t1 + ")");
   ...
   System.out.println("\u005ctTry: T -- > ID");
      t1 = jj_consume_token(ID);
    {if (true) return new IdentifierExp(t1.toString());}
  ...
  System.out.println("T --> THIS(" +t1 + ")");
   ...
   System.out.println("\u005ctTry: T -- > INTEGER_LITERAL");
      t1 = jj_consume_token(INTEGER_LITERAL);
        {if (true) return new IntegerLiteral(Integer.parseInt(t1.toString()));}
  ...
  static final public Exp K(Exp e) throws ParseException {
  Token t;
  ExpList el;
    if (jj_2_5(2)) {
  ...
  {if (true) return new Call(e, new Identifier(t.toString()), el);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case ID:
  ...
  static final public ArrayLookup L(Exp e) throws ParseException {
  Exp e1;
  ...
  static final public ExpList ExpRest(ExpList el) throws ParseException {
  Exp e;
    jj_consume_token(COMMA);
    e = Exp();
  ...
  static final public Exp Op(Exp e, Exp e1) throws ParseException {
        Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case PLUS:
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10000,0x1800000,0x20000,0x1800000,0x20000,0x10000,0x1a000000,0x0,0x1a000000,0x1a000000,0x0,0x800f80,0x800f80,0xc0003000,0x1000000,0x800000,0xc0002000,0x800000,0x800000,0x0,0x800f80,0x0,0x0,0xf80,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x1000,0x0,0x1000,0x0,0x0,0x1020,0x400,0x1020,0x20,0x1000,0x1280,0x1280,0x1007,0x1000,0x0,0x1001,0x1200,0x1200,0x80,0x1280,0x80,0x400,0x0,};
   }
